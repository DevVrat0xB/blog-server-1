...
class AutoIncrementImplementation extends fieldsLegacy.Implementation {
...
class KnexAutoIncrementInterface extends adapterKnexLegacy.KnexFieldAdapter {
  constructor() {
...
class PrismaAutoIncrementInterface extends adapterPrismaLegacy.PrismaFieldAdapter {
  constructor() {
    super(...arguments); // Default isUnique to true if not specified
...
const AutoIncrement = {
  ...
  views: {
    Controller: fieldsLegacy.Integer.views.Controller,
    Field: fieldsLegacy.Integer.views.Field,
    Filter: fieldsLegacy.Integer.views.Filter
  },
  adapters: {
